...
public class Encryption 
{
	...
	public String randString(int length)
	{
		...
		for (int i = 0;i < length;++i)
			out += (char)(randomGenerator.nextInt(480) + 33);
	...
	public String encrypt(String username, String password)
	{
		...
		//Gets a random number, and sets it as the first character, so it can be easily parsed.
		int randNum = new Random().nextInt(480) + 40;
		out += (char)(randNum);
